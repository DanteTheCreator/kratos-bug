...
import { V0alpha2Api, Configuration, Session, Identity, SubmitSelfServiceLoginFlowBody, SubmitSelfServiceRegistrationFlowBody } from "@ory/client"
...
const Register = () => {
  ...
  useEffect(() => {
    ...
    ory
      ...
      .catch(() => {
        ory.initializeSelfServiceRegistrationFlowForBrowsers().then(
          response => {      
  ...
  const handleSignup = (event:any) => {
    ...
    ory.submitSelfServiceRegistrationFlow(
     flowId!.toString(),  body
    ).then(
      _ => {
        router.push('/dashboard');
      }
      ...
      let messages = reason.response.data.ui.nodes.map((x:any) => x.messages).flat();
      
      if(messages.length > 0) {
        setErrorMessage(messages.map(x => x.text).join(' '));
      } else {
        setErrorMessage("");
      }
                ...
                <div className="col-lg-6 pe-10">
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <div className="ms-3">
                      ...
                      <p>Tortor mauris molestie elit, et lacinia ipsum quam nec dui. Quisque nec mauris sit amet elit iaculis pretium sit amet quis magna. </p>
                    </div>
                  </div>
                  <div className="d-flex flex-row">
                    <i className="uil uil-check-circle fs-17"></i>
                ...
                <div className="col-lg-6">
                  <div className="card shadow-lg">
                    <div className="p-10 p-md-11 p-lg-13">
                      <h2 className="mb-6 text-start">Create your Arcton account</h2>
                      ...
                      <p className="text-start pt-2 fs-13">
                        Already have an account? <Link className="" href="/auth/login">Log-in</Link>
                      </p>
                    </div>
                  </div>
                </div>
