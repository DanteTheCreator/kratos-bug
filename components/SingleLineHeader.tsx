...
export const WithHeader = (extraStyles: HeaderProps) => {
    ...
    return (
        <div className="d-flex justify-content-start bg-gray">
            <nav className="navbar navbar-expand-lg navbar navbar-light">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul className="navbar-nav d-flex flex-column justify-content-center align-items-center align-items-lg-start col-12 fs-18 ms-2">
                            <li className="nav-item">
                                <div className={`${styles.anchor} px-2 nav-link active py-2`} aria-current="page">
                                    <i className="uil uil-home me-2"></i>
                                    <Link href="/dashboard"><a className={`my-4 text-muted`}>Home</a></Link>
                                </div>
                            </li>
                            ...
                            <li className="nav-item">
                                <div className={`${styles.anchor} px-2 nav-link active py-2`} aria-current="page">
                                    ...
                                    <Link href="/dashboard/Profile"><a className={`my-4 text-muted`}>Profile</a></Link>
                                </div>
                            </li>
                            <li className="nav-item">
                                <div className={`${styles.anchor} px-2 nav-link active py-2`} aria-current="page">
                                    <i className="uil uil-wallet me-2"></i>
                                    <Link href="/dashboard/Wallet"><a className={`my-4 text-muted`}>Wallet</a></Link>
                                </div>
                            </li>
                            <li className="nav-item">
                                <div className={`${styles.anchor} px-2 nav-link active py-2`} aria-current="page">
                                    <i className="uil uil-shield-check me-2"></i>
                                    <Link href="/dashboard/Security"><a className={`my-4 text-muted`}>Security</a></Link>
                                </div>
                            </li>
                            <li className="nav-item">
                                <div className={`${styles.anchor} px-2 nav-link active py-2`} aria-current="page">
                                    <i className="uil uil-chart-line me-2"></i>
                                    <Link href="/dashboard/Transaction"><a className={`my-4 text-muted`}>Transaction</a></Link>
                                </div>
                            </li>
                        </ul>
                    </div>
